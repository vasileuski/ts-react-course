...
const getMovieByYear = (movies, number) => {
...
const getMovieByWord = (movies, str) => {
...
const getMovieByWord2 = (movies, str) => {
...
const getMovie = (movies, key, value) => {
